        ...
        {projects.length > 0 ? (
          projects.map((project, index) => (
            <FadeIn key={project._id} delay={index * 0.1}>
              <Card className="flex flex-col h-full border-none shadow-md hover:shadow-xl transition-all duration-300 bg-white/50 dark:bg-zinc-900/50 backdrop-blur-sm group overflow-hidden">
